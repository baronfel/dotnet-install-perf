...
TimeAndLog "extract zip" { Extract-Dotnet-Package -ZipPath $ZipPath -OutPath $InstallRoot }
...
TimeAndLog "delete zip" { SafeRemoveFile -Path $ZipPath }

TimeAndLog "configure" { Prepend-Sdk-InstallRoot-To-Path -InstallRoot $InstallRoot }
